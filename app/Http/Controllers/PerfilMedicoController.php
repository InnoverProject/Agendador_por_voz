...
class PerfilMedicoController extends Controller
{
    ...
    public function store(Request $request)
    {
          ...
          $perfilM=new Perfil_medico;

          try {

            
        $perfilM->cedula=$request->cedula;
        $perfilM->casa_estudio=$request->casa;
        $perfilM->descripcion=$request->descrip;
        $perfilM->id_medico=Auth::user()->medico->id;
        $perfilM->save();
        echo $perfilM->id;
        }
...
return view('admin.medico.perfilMed')->render();
    }
}
